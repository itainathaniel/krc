...
Vue.component('faces', __webpack_require__(13));
Vue.component('member', __webpack_require__(16));
...
Component.options.__file = "resources/assets/js/components/Faces.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-424c99e2", Component.options)
  } else {
    hotAPI.reload("data-v-424c99e2", Component.options)
' + '  }
...
var render = function() {
  ...
  return _c("div", { staticClass: "faces" }, [_vm._t("default")], 2)
}
var staticRenderFns = []
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-424c99e2", module.exports)
  }
}
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        getMemberClassname: function getMemberClassname() {
            var base = this.baseClassname + ' is-' + (!this.isPresent() ? 'not-' : '') + 'present';

            if (this.name.length >= this.longname) {
                return base + ' member__profile__long-name';
            }
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-57434291", module.exports)
  }
}
